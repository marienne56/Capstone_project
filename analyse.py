    ...
    if user_details is not None and isinstance(user_details, pd.Series):
        ...
        def load_data():
            try:
                ...
                # Don't convert identifiers to string to keep their original format
                # Identifiers will be used as they are stored in the database
        ...
        #st.write("📈 Detailed analysis of quarterly, semi-annual, and city-based consumption")
        ...
        # Period options - "Customized" replaced by "Monthly"
        ...
        # Apply filter by user identifier
        ...
        if selected_identifier != 'All users':
            ...
            user_info = df.iloc[0] if not df.empty else None
